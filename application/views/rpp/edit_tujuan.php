    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg">
                <a href="<?= base_url('rpp/tujuan'); ?>" class="btn btn-warning mb-3">Kembali Ke Menu Data</a>
                ...
                <form action="" method="post">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <input type="hidden" class="form-control" id="id_tujuan" name="id_tujuan" value="<?= $tujuanID['id_tujuan']; ?>">
                                ...
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <select name="id_mapel" id="id_mapel" class="form-control">
                                        ...
                                        <?php foreach ($mapel as $m) : ?>
                                            <?php if ($m->id_mapel == $tujuanID['id_mapel']) : ?>
                                ...
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <select name="id_rombel" id="id_rombel" class="form-control">
                                        ...
                                        <?php foreach ($rombel as $r) : ?>
                                            <?php if ($r->id_rombel == $tujuanID['id_rombel']) : ?>
                            ...
                            <div class="row">
                                <div class="mb-3 col-sm-4">
                                    ...
                                    <textarea type="text" class="form-control" id="t_condition" name="t_condition" placeholder="isikan target condition"><?= $tujuanID['t_condition']; ?></textarea>
                                    <?= form_error('t_condition', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3 col-sm-3">
                                    <label for="t_audience" class="form-label">Audience</label>
                                    <input type="text" class="form-control" id="t_audience" name="t_audience" placeholder="contoh : Siswa kelas X AKL" autocomplete="off" value="<?= $tujuanID['t_audience']; ?>">
                                ...
                                <div class="mb-3 col-sm-5">
                                    ...
                                    <select name="model_pemb" id="model_pemb" class="form-control">
                                        <option value="">Pilih Model Pembelajaran</option>
                                        <?php foreach ($model_pemb as $mp) : ?>
                                            <?php if ($mp['id'] == $tujuanID['id_model_pemb']) : ?>
                                                <option value="<?= $mp['id']; ?>" selected><?= $mp['jenis_model_pemb']; ?></option>
                                            <?php else : ?>
                                                <option value="<?= $mp['id']; ?>"><?= $mp['jenis_model_pemb']; ?></option>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                                <!-- <div class="mb-3 col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="" name="" value="<?= $tujuanID['jenis_model_pemb']; ?>" readonly>
                                ...
                                <div class="mb-3 col-sm-3">
                                    <label for="kko_pengetahuan" class="form-label">KKO Sebelumnya</label>
                                    <input type="text" class="form-control" id="" name="" value="<?= $tujuanID['kko_1']; ?>" readonly>
                                </div>
                                <div class="mb-3 col-sm-3">
                                ...
                                <div class="mb-3 col-sm-6">
                                    ...
                                    <textarea type="text" class="form-control" id="t_behaviour" name="t_behaviour" placeholder="isikan target behaviour"><?= $tujuanID['t_behaviour']; ?></textarea>
                                    <?= form_error('t_behaviour', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3 col-sm-3">
                                    <label for="kko_pengetahuan" class="form-label">KKO Sebelumnya</label>
                                    <input type="text" class="form-control" id="" name="" value="<?= $tujuanID['kko_2']; ?>" readonly>
                                </div>
                                <div class="mb-3 col-sm-3">
                                ...
                                <div class="mb-3 col-sm-6">
                                    <label for="t_behaviour" class="form-label">Behaviour</label>
                                    <textarea type="text" class="form-control" id="t_behaviour_2" name="t_behaviour_2" placeholder="isikan target behaviour"><?= $tujuanID['t_behaviour_2']; ?></textarea>
                                    <?= form_error('t_behaviour_2', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <!-- <div class="mb-3 col-sm-3">
                                    <label for="kko_pengetahuan" class="form-label">KKO Sebelumnya</label>
                                    <input type="text" class="form-control" id="" name="" value="<?= $tujuanID['kko_3']; ?>" readonly>
                                </div>
                                <div class="mb-3 col-sm-3">
                                    <label for="kko_pengetahuan" class="form-label">Ketik KKO Pengetahuan</label>
                                ...
                                <div class="mb-3 col-sm-6">
                                    <label for="t_behaviour" class="form-label">Behaviour</label>
                                    <textarea type="text" class="form-control" id="t_behaviour_3" name="t_behaviour_3" placeholder="isikan target behaviour"><?= $tujuanID['t_behaviour_3']; ?></textarea>
                                    <?= form_error('t_behaviour_3', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div> -->
                                <div class="mb-3 col-sm-3">
                                    <label for="kko_pengetahuan" class="form-label">KKO Sebelumnya</label>
                                    <input type="text" class="form-control" id="" name="" value="<?= $tujuanID['kko_4']; ?>" readonly>
                                </div>
                                <div class="mb-3 col-sm-3">
                                ...
                                <div class="mb-3 col-sm-6">
                                    <label for="t_behaviour" class="form-label">Behaviour</label>
                                    <textarea type="text" class="form-control" id="t_behaviour_4" name="t_behaviour_4" placeholder="isikan target behaviour"><?= $tujuanID['t_behaviour_4']; ?></textarea>
                                    <?= form_error('t_behaviour_4', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3 col-sm-4">
                                    <label for="t_condition" class="form-label">Literasi</label>
                                    <textarea type="text" class="form-control" id="t_m" name="t_m" placeholder="isikan target condition"><?= $tujuanID['t_m']; ?></textarea>
                                    <?= form_error('t_m', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3 col-sm-4">
                                    <label for="t_degree" class="form-label">Ketik 4C</label>
                                    <textarea type="text" class="form-control" id="t_4c" name="t_4c" placeholder="isikan target degree"><?= $tujuanID['t_4c']; ?></textarea>
                                    <?= form_error('t_4c', '<small class="text-danger pl-3">', '</small>'); ?>
                                </div>
                                <div class="mb-3 col-sm-4">
                                    <label for="t_degree" class="form-label">Degree</label>
                                    <textarea type="text" class="form-control" id="t_degree" name="t_degree" placeholder="isikan target degree"><?= $tujuanID['t_degree']; ?></textarea>
