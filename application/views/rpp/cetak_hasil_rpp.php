...
<head>
    <title>Cetak RPP 1 Lembar</title>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <ul>
                                        <p>
                                            <?= $cetak_rpp['t_audience']; ?> (A) <?= $cetak_rpp['kko_1']; ?> <?= $cetak_rpp['t_behaviour']; ?> <?= $cetak_rpp['kko_2']; ?> <?= $cetak_rpp['t_behaviour_2']; ?> <?= $cetak_rpp['kko_3']; ?> <?= $cetak_rpp['t_behaviour_3']; ?> <?= $cetak_rpp['kko_4']; ?> <?= $cetak_rpp['t_behaviour_4']; ?> (B) <?= $cetak_rpp['t_condition']; ?> (C) <?= $cetak_rpp['t_degree']; ?> (D) dengan menggunakan metode pembelajaran <?= $cetak_rpp['jenis_model_pemb']; ?></p>
                                    </ul>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['sintak1']; ?></td>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['aktifitas1']; ?></td>
                                            </tr>
                                            <tr>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['sintak2']; ?></td>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['aktifitas2']; ?></td>
                                            </tr>
                                            <tr>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['sintak3']; ?></td>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['aktifitas3']; ?></td>
                                            </tr>
                                            <tr>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['sintak4']; ?></td>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['aktifitas4']; ?></td>
                                            </tr>
                                            <tr>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['sintak5']; ?></td>
                                                <td scope="col" class="text-center"><?= $cetak_rpp['aktifitas5']; ?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <h6>c. Kegiatan Penutup </h6>
                                    <ul>1. <?= $cetak_rpp['keg_akhir']; ?></ul>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-12">
