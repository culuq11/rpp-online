...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label">NIP Lengkap</label>
                <div class="col-sm-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?= $user['tempat_lahir']; ?>" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="tanggal_lahir" name="tanggal_lahir" value="<?= $user['tanggal_lahir']; ?>" autocomplete="off">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="jenis_kelamin" name="jenis_kelamin" value="<?= $user['jenis_kelamin']; ?>" autocomplete="off">
